...
```sh
git clone https://github.com/nickjj/docker-django-example cryptobro
cd cryptobro
...
The app is named `cryptobro` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "cryptobro" and update a few Docker related resources.
